...
public class PsiOrBexprImpl extends PsiBinaryBexprImpl implements PsiOrBexpr {

  public PsiOrBexprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PsiVisitor) ((PsiVisitor)visitor).visitOrBexpr(this);
