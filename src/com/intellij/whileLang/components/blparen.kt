...
): WhilePsiElementComponent<PsiParenBexpr, SmartInsertPlace, PsiTemplateGen<PsiParenBexpr, SmartInsertPlace>>(printer)
   
{
    ...
    override protected fun getNewElement(
        ...
        try {
            ...
            val newP = elementFactory.createParenBexprFromText(text)
